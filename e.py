    ...
    with requests.Session() as xyz:
         try:
              ...
              xyz.headers.update({
                  ...
                  'x-requested-with': 'XMLHttpRequest',
                  'sec-ch-ua-mobile': '?1',
                  'user-agent': 'Mozilla/5.0 (Linux; Android 12; Oppo A53) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36',
    ...
    with requests.Session() as xyz:
         try:
             ...
             xyz.headers.update({
                 'Host': 'instagram.qlizz.com',
                 'content-length': '121',
                 'sec-ch-ua': '"Google Chrome";v="197", "Chromium";v="197", "Not=B?Brand";v="44"',
                 'accept': '*/*',
